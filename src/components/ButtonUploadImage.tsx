...
export default function ButtonUploadImage({ onUpload }: { onUpload: (image: string | null) => void }) {
    ...
    return (
        <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-1.5 px-4 rounded inline-flex items-center cursor-pointer">
            ...
            <div className="">nahrát soubor</div>
        </button>
    );
}
